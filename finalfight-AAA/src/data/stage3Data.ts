...
export const stage3Data: StageData = {
  ...
  props: [
    { worldX: 600,  worldY: groundMidY, type: 'barrel', hp: GameConfig.PROP_BARREL_HP, dropItemType: 'health', dropChance: GameConfig.BARREL_DROP_CHANCE_DEFAULT },
    { worldX: 1000, worldY: groundMidY, type: 'crate',  hp: GameConfig.PROP_CRATE_HP,  dropItemType: null,     dropChance: 0 },
    { worldX: 2000, worldY: groundMidY, type: 'barrel', hp: GameConfig.PROP_BARREL_HP, dropItemType: 'score',  dropChance: 1.0 },
    { worldX: 3200, worldY: groundMidY, type: 'crate',  hp: GameConfig.PROP_CRATE_HP,  dropItemType: 'health', dropChance: GameConfig.BARREL_DROP_CHANCE_DEFAULT },
    { worldX: 4400, worldY: groundMidY, type: 'barrel', hp: GameConfig.PROP_BARREL_HP, dropItemType: null,     dropChance: 0 },
    { worldX: 5600, worldY: groundMidY, type: 'crate',  hp: GameConfig.PROP_CRATE_HP,  dropItemType: 'score',  dropChance: 1.0 },
    { worldX: 6600, worldY: groundMidY, type: 'barrel', hp: GameConfig.PROP_BARREL_HP, dropItemType: 'health', dropChance: GameConfig.BARREL_DROP_CHANCE_DEFAULT },
  ],
} as const;
